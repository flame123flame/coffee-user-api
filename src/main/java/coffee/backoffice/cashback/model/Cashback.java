...
public class Cashback implements Serializable{/**
	 * 
	 */
	private static final long serialVersionUID = -1158444611554423002L;
    ...
    @Column(name = "cashback_condition_multiplier")
    ...
    public void setReqToEntity(CashbackReq req) {
        ...
        isAutoCashback = req.getIsAutoCashback() == null ? isAutoCashback : req.getIsAutoCashback();
        ...
        cashbackConditionMultiplier = req.getCashbackConditionMultiplier() == null ? cashbackConditionMultiplier : req.getCashbackConditionMultiplier();
